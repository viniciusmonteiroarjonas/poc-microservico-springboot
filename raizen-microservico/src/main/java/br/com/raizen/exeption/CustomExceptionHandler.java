...
public class CustomExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleUserNotFoundException(
            CepNotFoundExeption exception, WebRequest request) {

        ApiErrorMessage apiErrorMessage = new ApiErrorMessage(HttpStatus.NOT_FOUND, Collections.singletonList(exception.getMessage()));
